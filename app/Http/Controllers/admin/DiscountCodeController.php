...
class DiscountCodeController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        if($validator->passes()) {
            ...
            // starting datae must be greater than current date
            ...
            $message = 'Discount ccoupon added successfully.';
    ...
    public function update(Request $request, $id) {
        ...
        if($validator->passes()) {
            ...
            $message = 'Discount ccoupon updated successfully.';
            session()->flash('success', $message);
            return response()->json([
                'status' => true,
                'message' => $message
    ...
    public function destroy(Request $request, $id) {
        ...
        session()->flash('success', 'Dsicount Coupon deleted succesfully.');
            return response()->json([
                'status' => true,
            ]);
    }
