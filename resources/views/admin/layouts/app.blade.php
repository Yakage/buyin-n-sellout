...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="{{ secure_asset('admin_assets/plugins/dropzone/min/dropzone.min.css') }}">

		<link rel="stylesheet" href="{{ secure_asset('admin_assets/plugins/summernote/summernote.min.css') }}">
